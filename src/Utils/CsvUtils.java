...
//        return d.getDayOfMonth() + "/" + d.getMonthValue() + "/" + d.getYear() ;
    ...
    /**
     * Validates whether the input string is a valid marital status.
     * Accepts "Single" or "Married" (case-insensitive).
     *
     * @param input the marital status input to validate
